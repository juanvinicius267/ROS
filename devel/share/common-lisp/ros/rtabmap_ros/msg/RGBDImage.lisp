...
(cl:defclass <RGBDImage> (roslisp-msg-protocol:ros-message)
  ((header
   ...
   (rgbCameraInfo
    :reader rgbCameraInfo
    :initarg :rgbCameraInfo
    :type sensor_msgs-msg:CameraInfo
    :initform (cl:make-instance 'sensor_msgs-msg:CameraInfo))
   (depthCameraInfo
    :reader depthCameraInfo
    :initarg :depthCameraInfo
    :type sensor_msgs-msg:CameraInfo
    :initform (cl:make-instance 'sensor_msgs-msg:CameraInfo))
   (rgb
    :reader rgb
   ...
   (depth
    ...
    :initform (cl:make-instance 'sensor_msgs-msg:Image))
   (rgbCompressed
    :reader rgbCompressed
    :initarg :rgbCompressed
    :type sensor_msgs-msg:CompressedImage
    :initform (cl:make-instance 'sensor_msgs-msg:CompressedImage))
   (depthCompressed
    :reader depthCompressed
    :initarg :depthCompressed
    :type sensor_msgs-msg:CompressedImage
    :initform (cl:make-instance 'sensor_msgs-msg:CompressedImage)))
)
...
(cl:ensure-generic-function 'rgbCameraInfo-val :lambda-list '(m))
(cl:defmethod rgbCameraInfo-val ((m <RGBDImage>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader rtabmap_ros-msg:rgbCameraInfo-val is deprecated.  Use rtabmap_ros-msg:rgbCameraInfo instead.")
  (rgbCameraInfo m))

(cl:ensure-generic-function 'depthCameraInfo-val :lambda-list '(m))
(cl:defmethod depthCameraInfo-val ((m <RGBDImage>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader rtabmap_ros-msg:depthCameraInfo-val is deprecated.  Use rtabmap_ros-msg:depthCameraInfo instead.")
  (depthCameraInfo m))
...
(cl:ensure-generic-function 'rgbCompressed-val :lambda-list '(m))
(cl:defmethod rgbCompressed-val ((m <RGBDImage>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader rtabmap_ros-msg:rgbCompressed-val is deprecated.  Use rtabmap_ros-msg:rgbCompressed instead.")
  (rgbCompressed m))

(cl:ensure-generic-function 'depthCompressed-val :lambda-list '(m))
(cl:defmethod depthCompressed-val ((m <RGBDImage>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader rtabmap_ros-msg:depthCompressed-val is deprecated.  Use rtabmap_ros-msg:depthCompressed instead.")
  (depthCompressed m))
(cl:defmethod roslisp-msg-protocol:serialize ((msg <RGBDImage>) ostream)
  ...
  (roslisp-msg-protocol:serialize (cl:slot-value msg 'rgbCameraInfo) ostream)
  (roslisp-msg-protocol:serialize (cl:slot-value msg 'depthCameraInfo) ostream)
  ...
  (roslisp-msg-protocol:serialize (cl:slot-value msg 'rgbCompressed) ostream)
  (roslisp-msg-protocol:serialize (cl:slot-value msg 'depthCompressed) ostream)
)
(cl:defmethod roslisp-msg-protocol:deserialize ((msg <RGBDImage>) istream)
  ...
  (roslisp-msg-protocol:deserialize (cl:slot-value msg 'rgbCameraInfo) istream)
  (roslisp-msg-protocol:deserialize (cl:slot-value msg 'depthCameraInfo) istream)
  ...
  (roslisp-msg-protocol:deserialize (cl:slot-value msg 'rgbCompressed) istream)
  (roslisp-msg-protocol:deserialize (cl:slot-value msg 'depthCompressed) istream)
  msg
)
...
(cl:defmethod roslisp-msg-protocol:md5sum ((type (cl:eql '<RGBDImage>)))
  ...
  "a7fa8f34f44b976b3b2dec13c02f9f0e")
(cl:defmethod roslisp-msg-protocol:md5sum ((type (cl:eql 'RGBDImage)))
  "Returns md5sum for a message object of type 'RGBDImage"
  "a7fa8f34f44b976b3b2dec13c02f9f0e")
...
(cl:defmethod roslisp-msg-protocol:serialization-length ((msg <RGBDImage>))
  (cl:+ 0
     ...
     (roslisp-msg-protocol:serialization-length (cl:slot-value msg 'rgbCameraInfo))
     (roslisp-msg-protocol:serialization-length (cl:slot-value msg 'depthCameraInfo))
     ...
     (roslisp-msg-protocol:serialization-length (cl:slot-value msg 'rgbCompressed))
     (roslisp-msg-protocol:serialization-length (cl:slot-value msg 'depthCompressed))
))
(cl:defmethod roslisp-msg-protocol:ros-message-to-list ((msg <RGBDImage>))
  "Converts a ROS message object to a list"
  (cl:list 'RGBDImage
    (cl:cons ':header (header msg))
    (cl:cons ':rgbCameraInfo (rgbCameraInfo msg))
    (cl:cons ':depthCameraInfo (depthCameraInfo msg))
    (cl:cons ':rgb (rgb msg))
    (cl:cons ':depth (depth msg))
    (cl:cons ':rgbCompressed (rgbCompressed msg))
    (cl:cons ':depthCompressed (depthCompressed msg))
))
