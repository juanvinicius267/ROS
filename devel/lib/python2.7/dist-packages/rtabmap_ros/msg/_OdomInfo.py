...
class OdomInfo(genpy.Message):
  _md5sum = "edc18a7e4a936ef7e55b956a4970261e"
...
float32 z"""
  ...
  _slot_types = ['std_msgs/Header','bool','int32','int32','float32','float32','float32','float32','float64[36]','int32','int32','int32','int32','int32','int32','float32','bool','float32','float32','float32','float32','float32','int32','geometry_msgs/Transform','geometry_msgs/Transform','geometry_msgs/Transform','geometry_msgs/Transform','int32','int32[]','rtabmap_ros/KeyPoint[]','int32[]','int32[]','int32[]','rtabmap_ros/Point3f[]','uint8[]','rtabmap_ros/Point2f[]','rtabmap_ros/Point2f[]','int32[]']
  ...
  def serialize(self, buff):
    ...
    try:
      ...
      _x = self
      buff.write(_get_struct_B2i4f().pack(_x.lost, _x.matches, _x.inliers, _x.icpInliersRatio, _x.icpRotation, _x.icpTranslation, _x.icpStructuralComplexity))
  ...
  def deserialize(self, str):
    ...
    try:
      ...
      (_x.lost, _x.matches, _x.inliers, _x.icpInliersRatio, _x.icpRotation, _x.icpTranslation, _x.icpStructuralComplexity,) = _get_struct_B2i4f().unpack(str[start:end])
...
def _get_struct_3f2i():
    ...
    return _struct_3f2i
_struct_B2i4f = None
def _get_struct_B2i4f():
    global _struct_B2i4f
    if _struct_B2i4f is None:
        _struct_B2i4f = struct.Struct("<B2i4f")
    return _struct_B2i4f
_struct_36d = None
def _get_struct_36d():
    global _struct_36d
